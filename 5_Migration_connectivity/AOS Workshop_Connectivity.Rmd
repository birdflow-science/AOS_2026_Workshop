...
```{r}
setwd("~/Documents/GitHub/BirdFlow_connectivity/AOS_workshop")
...
migratory connectivity as the relative proportions of individuals migrating between these selected breeding and non-breeding MCRs for each species
...
bottleneck problems requirement of tracking data
